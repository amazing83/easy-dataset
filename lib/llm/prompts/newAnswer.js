...
export function getNewAnswerPrompt(language, { question, answer, cot, advice, chunkContent }) {
  const prompt = (language === 'en' ? NEW_ANSWER_PROMPT_EN : NEW_ANSWER_PROMPT)
